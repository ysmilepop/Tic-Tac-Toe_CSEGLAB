	...
	public void initialize() {
		try {
			...
			String createMovesTableSQL = "CREATE TABLE IF NOT EXISTS game_moves ("
					+ "id INTEGER PRIMARY KEY AUTOINCREMENT, " + "game_id INTEGER, " + "player TEXT NOT NULL, "
					+ "move_row INTEGER NOT NULL, " + "move_col INTEGER NOT NULL, " + "board_state TEXT NOT NULL, "
			...
			String createResultsTableSQL = "CREATE TABLE IF NOT EXISTS game_results ("
					+ "id INTEGER PRIMARY KEY AUTOINCREMENT, " + "game_state TEXT NOT NULL, " + "result TEXT NOT NULL, "
					+ "timestamp DATETIME DEFAULT CURRENT_TIMESTAMP)";
		...
		try {
			...
			while (rs.next()) {
				...
				while (moves.next()) {
					...
					JLabel moveLabel = new JLabel("Move " + moveNumber + ": " + moves.getString("player")
							+ " moved to (" + moves.getInt("move_row") + ", " + moves.getInt("move_col") + ")");
